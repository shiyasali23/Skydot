...
const ProductsPage = () => {
  ...
  {productsArray ? (
    productsArray.map((item, index) => (
      <div className="product-card" key={index}>
        ...
        <img
          ...
          alt="product-img"
        />
        <h5 className="product-card-value product-card-name">{item.name}</h5>
        ...
        <Link className="product-card-value" to={`/edit-product/${item.id}`}>
    ...
    <h3 style={{width:'100%',height:'100%',textAlign:'center',margin:'10% 0px'}}>Oops Something Went Wrong...</h3>
