      ...
      <table className="table">
        <thead className="table-thead">
          <tr>
            ...
            <th className="table-header"><i class="fa-solid fa-truck-fast"></i></th>
          </tr>
        </thead>
        ...
        <tbody className="table-tbody">
          {ordersArray.map((order, index) => (
            <tr className="table-row" key={order.id}>
              ...
              <td className="table-value">{order.order_products.reduce((total, product) => total + product.quantity, 0)}</td>
